    ...
    <AnimatePresence>
      {matches.length > 0 && (
        <motion.div
          ...
          className="absolute top-32 left-4 md:left-8 z-40 w-[300px] md:w-[350px] bg-dark/80 backdrop-blur-md border border-white/10 rounded-xl shadow-[0_8px_32px_rgba(0,0,0,0.3)] overflow-hidden"
        >
          {/* Header */}
