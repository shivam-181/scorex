    ...
    <div ref={constraintsRef} className="fixed inset-0 pointer-events-none z-50">
      <AnimatePresence>
        <motion.div
          ...
          className="absolute bottom-4 right-4 w-full max-w-xs md:max-w-sm cursor-grab active:cursor-grabbing pointer-events-auto"
        >
          <div className="bg-dark/90 backdrop-blur-md border border-white/10 rounded-xl shadow-2xl p-4 flex items-center justify-between relative overflow-hidden">
            ...
            <div className="flex items-center gap-4 w-full">
              ...
              <div className="flex-1 flex justify-between items-center px-2">
                ...
                <div className="px-3 py-1 bg-white/5 rounded-lg font-mono font-black text-white whitespace-nowrap shrink-0">
